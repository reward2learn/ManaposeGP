...
export const sendStreamingMessage = createAsyncThunk<
  void,
  { message: string; history: ChatStreamMessage[]; attachments?: ChatAttachment[]; mode?: string },
  { rejectValue: string }
>('chatStream/sendStreamingMessage', async ({ message, history, attachments, mode }, { dispatch, rejectWithValue }) => {
