...
export const EXECUTIVE_SUMMARY_FALLBACK = `# ManaposeGP — Platform Overview
### AI-Powered Business Operations Platform | v1.0.0
...
*Full analysis: Parts A–N in the main Business Review. Part O (Tax Structure Analysis) available as a dedicated section. Live at manaposegp.vercel.app*`;
...
export function buildStructuredPromptFromSnippets(
  ...
  const sections: string[] = [
    'You are ManaposeGP AI — a women\'s health companion supporting patients through menopause with symptom tracking, health education, GP preparation, and evidence-based guidance.',
    '',
    '## Your Role',
    'Help women understand menopause symptoms, track their health journey, prepare for GP consultations, access evidence-based treatment information, and receive compassionate support throughout perimenopause and beyond. Never diagnose — always encourage speaking with a GP.',
  ];

  const categoryTitles: Record<string, string> = {
    overview: '## About Menopause',
    strategy: '## Treatment Options',
    metrics: '## Health Tracking',
    actions: '## Next Steps',
    risks: '## When to See Your GP',
  };
